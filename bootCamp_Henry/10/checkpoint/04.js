...
//
//
// 4️⃣ ***** EJERCICIO 4 ***** - construccionCasas() 4️⃣ // LISTO
...
function construccionCasas(bolsas) {
    ...
    return function(casas){
          ...
          if(casas > bolsasAcasas){ 
            return `Solo puedes construir esta cantidad de casas: ${Math.floor(bolsasAcasas)}`;
          }
          if(casas % bolsasAcasas === 0) return true;
      }
  };
